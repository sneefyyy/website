    ...
    <>
      ...
      <div style={{
        ...
        <div 
          ...
          style={{ backgroundColor: '#000c38', height: '100vh', left: '0vw', position: 'absolute', top: '0', transform: 'translate(0px, 0px)', width: '20vw' }}
        >
        ...
        <div 
          ...
          onMouseLeave={() => setHoveredIndex(-1)}
          style={{ backgroundColor: '#000c38', height: '100vh', left: '20vw', position: 'absolute', top: '0', transform: 'translate(0px, 0px)', width: '20vw' }}
        >
        ...
        <div
          ...
          onMouseLeave={() => setHoveredIndex(-1)}
          style={{ backgroundColor: '#000c38', height: '100vh', left: '40vw', position: 'absolute', top: '0', transform: 'translate(0px, 0px)', width: '20vw' }}
        >
        ...
        <div
          ...
          onMouseLeave={() => setHoveredIndex(-1)}
          style={{ backgroundColor: '#000c38', height: '100vh', left: '60vw', position: 'absolute', top: '0', transform: 'translate(0px, 0px)', width: '20vw' }}
        >
        ...
        <div
          ...
          onMouseLeave={() => setHoveredIndex(-1)}
          style={{ backgroundColor: '#000c38', height: '100vh', left: '80vw', position: 'absolute', top: '0', transform: 'translate(0px, 0px)', width: '20vw' }}
        >
